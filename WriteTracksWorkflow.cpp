...
// Per-track state for a write built from the source disc's pregap layout.
// The PCM-payload half lives in WavPayload (AudioFileSource.h) because the
// CUE-sheet write workflow needs exactly that half and none of the rest.
struct TrackSource : WavPayload {
