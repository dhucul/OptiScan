...
extern const LPCWSTR CommandLabels[COMMAND_BUTTON_COUNT] =
{
	...
	L"7. Quality scan (hardware error graphs) *",
    L"8. C2 error scan *",
    L"9. BLER scan (detailed) *",
    L"10. Disc rot detection *",
    L"11. Generate surface map *",
    L"12. Multi-pass verification *",
    L"13. Compare disc CRCs (original vs. copy) *",
    L"14. Audio content analysis *",
    L"15. Disc fingerprint (CDDB/MusicBrainz/AccurateRip IDs) *",
    L"16. Lead area check *",
    L"17. Subchannel integrity check *",
    L"18. Verify subchannel burn status *",
    L"19. Copy-protection check *",
    L"20. Drive capabilities & characterization *",
    L"21. Drive offset detection *",
    L"22. C2 validation test *",
    L"23. Speed comparison test *",
    L"24. Seek time analysis *",
    L"25. Chipset identification",
    L"26. Disc balance check *",
    L"27. Rescan disc",
    L"28. Check for updates",
    L"29. Help (test descriptions)",
    L"30. Pioneer CD Check (audio quality) *",
